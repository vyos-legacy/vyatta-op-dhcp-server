...
<xsl:variable name="pad15" select="'               '"/>
<xsl:variable name="pad15_len" select="string-length($pad15)"/>
...
<xsl:value-of select="substring($pad15,1,$pad15_len - string-length(shared_network))"/>
